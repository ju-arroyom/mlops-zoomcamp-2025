...
HPO_EXPERIMENT_NAME = "random-forest-hyperopt-fix"
...
def run_register_model(data_path: str, top_n: int):
    ...
    print(f"run: {best_run.info.run_id}, test rmse: {best_run.data.metrics['test_rmse']:.4f}")
    # Register the best model
    model_uri = f"runs:/{best_run.info.run_id}/model"
    mlflow.register_model(model_uri=model_uri, name="nyc-taxi-rf")
